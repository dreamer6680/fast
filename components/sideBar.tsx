...
import { SidebarItem, SidebarFolder, SidebarFolderTrigger, SidebarFolderContent, SidebarFolderLink } from "fumadocs-ui/components/layout/sidebar";
...
const CustomFolder: FC<{ item: PageTree.Folder; level: number; children: ReactNode }> = ({ item, level, children }) => (
